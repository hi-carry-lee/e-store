        ...
        <div className="md:col-span-2 overflow-x-auto space-y-4">
          ...
          <Card>
            <CardContent className="p-4 gap-4">
              ...
              {/* HTML 表格（<table>）默认的 display 值是 table，而 overflow-y 属性只对块级元素（block-level elements）有效 */}
              <Table className="block max-h-[500px] overflow-y-auto">
